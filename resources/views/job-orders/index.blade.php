                ...
                <div class="col-md-10 vr">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            @include('job-orders.details.mom.index')
                            @include('job-orders.details.event.index')
                            @include('job-orders.details.project.index')
                            @include('job-orders.details.client.index')
                            @include('job-orders.details.status.index')
                            @include('job-orders.details.requests.index')
                            @include('job-orders.details.discussion.index')
                        </div>
                    </div>
                </div>
            </div>
