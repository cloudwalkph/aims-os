        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">
                    ...
                    @if(Auth()->user()->department->slug != "creatives")
                ...
                <div class="col-md-12">
                    <form method="POST">
                        ...
                        <textarea class="comments" name="message" placeholder="Write a comment..."
                              ...
                              line-height: 18px; border:1px solid #dddddd; padding: 10px; " disabled required>
                        </textarea>

                        <div class="row">
                            <div class="col-md-2 col-md-offset-6">
                                <input type="file" name="file" id="uploadFile" disabled/>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <button type="button" class="btn btn-block btn-primary pull-right" disabled>Post</button>
                            </div>
                        </div>
                    </form>
                </div>
