    ...
    t.fn.Tabledit = function(e) {
        function n(e) {
            var n = i.find(".tabledit-input").serialize() + "&action=" + e,
                a = d.onAjax(e, n);
            if (a === !1) return !1;
            var o = t.post(d.url, n, function(t, n, a) {
            ...
            return o.fail(function(t, n, i) {
                e === d.buttons["delete"].action ? (l.removeClass(d.mutedClass).addClass(d.dangerClass), l.find(".tabledit-toolbar button").attr("disabled", !1), l.find(".tabledit-toolbar .tabledit-restore-button").hide()) : e === d.buttons.edit.action && s.addClass(d.dangerClass), d.onFail(t, n, i)
            }), o.always(function() {
                d.onAlways()
            }), o
        }
                ...
                columns: {
                        ...
                        for (var e = 0; e < d.columns.editable.length; e++) {
                            ...
                            n.each(function() {
                                ...
                                var i = '<span class="tabledit-span">' + n + "</span>",
                                    a = "";
                                switch (d.columns.editable[e][2]) {
                                    case "textarea":
                                        a = "<textarea ", t.each(d.columns.editable[e][3], function(t, e) {
                                            a += t + '="' + e + '" '
                                        }), a += 'class="tabledit-input ' + d.inputClass + '" name="' + d.columns.editable[e][1] + '" style="display: none;" disabled>' + t(this).text() + "</textarea>";
                                        break;
                                    case "select":
                                        a = '<select class="tabledit-input ' + d.inputClass + '" name="' + d.columns.editable[e][1] + '" style="display: none;" disabled>', t.each(d.columns.editable[e][3], function(t, e) {
                                            a += n === e ? '<option value="' + t + '" selected>' + e + "</option>" : '<option value="' + t + '">' + e + "</option>"
                                        }), a += "</select>";
                                        break;
                                    case "number":
                                        a = '<input class="tabledit-input ' + d.inputClass + '" type="number" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none;" disabled>';
                                        break;
                                    case "file":
                                        a = '<input class="tabledit-input ' + d.inputClass + '" type="file" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none;" disabled>';
                                        break;
                                    default:
                                        a = '<input class="tabledit-input ' + d.inputClass + '" type="text" name="' + d.columns.editable[e][1] + '" value="' + t(this).text() + '" style="display: none;" disabled>'
                                }
                    ...
                    toolbar: function() {
                        if (d.editButton || d.deleteButton) {
                            ...
                            var l = '<div class="tabledit-toolbar ' + d.toolbarClass + '" style="text-align: left;">\n                                           <div class="' + d.groupClass + '" style="float: none;">' + t + e + "</div>\n                                           " + n + "\n                                           " + s + "\n                                           " + a + "\n                                       </div></div>";
                            i.find("tbody>tr").append('<td style="white-space: nowrap; width: 1%;">' + l + "</td>")
                        }
                    }
                }
            },
            ...
            b = {
                ...
                submit: function(e) {
                    ...
                    i !== !1 && (t(e).each(function() {
                        var e = t(this).find(".tabledit-input");
                        e.is("select") ? t(this).find(".tabledit-span").text(e.find("option:selected").text()) : t(this).find(".tabledit-span").text(e.val()), u.view(this)
                    }), s = t(e).parent("tr"))
                }
            },
            c = {
                ...
                submit: function(e) {
                    ...
                    t(e).parents("tr").find("input.tabledit-identifier").attr("disabled", !0), i !== !1 && (t(e).parent("tr").addClass("tabledit-deleted-row"), t(e).parent("tr").addClass(d.mutedClass).find(".tabledit-toolbar button:not(.tabledit-restore-button)").attr("disabled", !0), t(e).find(".tabledit-restore-button").show(), l = t(e).parent("tr"))
                },
                confirm: function(e) {
                ...
                restore: function(e) {
                    ...
                    t(e).parents("tr").find("input.tabledit-identifier").attr("disabled", !0), i !== !1 && (t(e).parent("tr").removeClass("tabledit-deleted-row"), t(e).parent("tr").removeClass(d.mutedClass).find(".tabledit-toolbar button").attr("disabled", !1), t(e).find(".tabledit-restore-button").hide(), o = t(e).parent("tr"))
                }
            };
