...
class AssignmentUpdated extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'status'        => 'unread',
            'message'       => $this->user->profile->full_name . ' on ' . $this->user->department->name . ' Updated the task on the Job Order '.$this->jo->job_order_no,
