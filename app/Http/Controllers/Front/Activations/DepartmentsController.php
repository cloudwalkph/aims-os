...
class DepartmentsController extends Controller
{
    ...
    public function show($departmentId)
    {
        ...
        if($departmentId == 11) {
            ...
            return view('activations.departments.'.$department->slug.'.index', compact('assigned', 'users'));
        }

        return view('activations.departments.'.$department->slug.'.index');
    }
    ...
    public function showDetails($departmentId, $joNo)
    {
        ...
        return view('activations.departments.'.$department->slug.'.show');
    }
